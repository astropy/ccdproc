...
# Wrapped_functions
median_filter = support_nddata(ndimage.median_filter, repack=True,
                               returns=['data'], keeps=['meta', 'unit'],
                               data='input')
# The table in the docstring is AUTOGENERATED, so any changes to the layout
# should be propagated to the ccdproc-support_nddata decorator internals
# (there is a longish inline comment which produces it).
